...
#
# ZynqMP_FFT.tcl: Tcl script for re-creating project 'ZynqMP_FFT'
#
# Generated by Vivado on Tue Jul 19 20:51:08 CDT 2022
...
#
# 1. This project restoration tcl script (ZynqMP_FFT.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/slmckenzie/Documents/vivado-projects/ZynqMP_FFT/ZynqMP_FFT.srcs/utils_1/imports/synth_1/zynqmp_system_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../ZynqMP_FFT.srcs/utils_1/imports/synth_1/zynqmp_system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "ZynqMP_FFT"
...
set script_file "ZynqMP_FFT.tcl"
...
set_property -name "top" -value "zynqmp_system_wrapper" -objects $obj
...
set file "synth_1/zynqmp_system_wrapper.dcp"
...
# Proc to create BD zynqmp_system
proc cr_bd_zynqmp_system { parentCell } {
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;800000000;0|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;1|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net DMA_M_AXI_S2MM [get_bd_intf_pins DMA/M_AXI_S2MM] [get_bd_intf_pins ZYNQ_PS/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net ZYNQ_PS_M_AXI_HPM0_FPD [get_bd_intf_pins AXI_INTERCONNECT/S00_AXI] [get_bd_intf_pins ZYNQ_PS/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net ZYNQ_PS_M_AXI_HPM1_FPD [get_bd_intf_pins AXI_INTERCONNECT/S01_AXI] [get_bd_intf_pins ZYNQ_PS/M_AXI_HPM1_FPD]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins DMA/M_AXIS_MM2S] [get_bd_intf_pins FFT/S_AXIS_DATA]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins AXI_INTERCONNECT/M00_AXI] [get_bd_intf_pins DMA/S_AXI_LITE]
  connect_bd_intf_net -intf_net xfft_0_M_AXIS_DATA [get_bd_intf_pins DMA/S_AXIS_S2MM] [get_bd_intf_pins FFT/M_AXIS_DATA]

  # Create port connections
  connect_bd_net -net ZYNQ_PS_pl_resetn0 [get_bd_pins ZYNQ_PS/pl_resetn0] [get_bd_pins rst_ps8_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins AXI_INTERCONNECT/ARESETN] [get_bd_pins AXI_INTERCONNECT/M00_ARESETN] [get_bd_pins AXI_INTERCONNECT/S00_ARESETN] [get_bd_pins AXI_INTERCONNECT/S01_ARESETN] [get_bd_pins DMA/axi_resetn] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins FFT/s_axis_config_tvalid] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins FFT/s_axis_config_tdata] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins AXI_INTERCONNECT/ACLK] [get_bd_pins AXI_INTERCONNECT/M00_ACLK] [get_bd_pins AXI_INTERCONNECT/S00_ACLK] [get_bd_pins AXI_INTERCONNECT/S01_ACLK] [get_bd_pins DMA/m_axi_mm2s_aclk] [get_bd_pins DMA/m_axi_s2mm_aclk] [get_bd_pins DMA/s_axi_lite_aclk] [get_bd_pins FFT/aclk] [get_bd_pins ZYNQ_PS/maxihpm0_fpd_aclk] [get_bd_pins ZYNQ_PS/maxihpm1_fpd_aclk] [get_bd_pins ZYNQ_PS/pl_clk0] [get_bd_pins ZYNQ_PS/saxihp0_fpd_aclk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces DMA/Data_S2MM] [get_bd_addr_segs ZYNQ_PS/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces DMA/Data_S2MM] [get_bd_addr_segs ZYNQ_PS/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ZYNQ_PS/Data] [get_bd_addr_segs DMA/S_AXI_LITE/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces DMA/Data_S2MM] [get_bd_addr_segs ZYNQ_PS/SAXIGP2/HP0_LPS_OCM]

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.936538",
   "Default View_TopLeft":"-10,-185",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace inst DMA -pg 1 -lvl 3 -x 1330 -y 320 -defaultsOSRD
preplace inst AXI_INTERCONNECT -pg 1 -lvl 2 -x 900 -y 180 -defaultsOSRD
preplace inst FFT -pg 1 -lvl 2 -x 900 -y 450 -defaultsOSRD
preplace inst rst_ps8_0_100M -pg 1 -lvl 3 -x 1330 -y 120 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -x 330 -y 500 -defaultsOSRD
preplace inst ZYNQ_PS -pg 1 -lvl 1 -x 330 -y 120 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 1 -x 330 -y 400 -defaultsOSRD
preplace netloc ZYNQ_PS_pl_resetn0 1 1 2 620 30 1140
preplace netloc rst_ps8_0_100M_peripheral_aresetn 1 1 3 650 330 1120 440 1500
preplace netloc xlconstant_0_dout 1 1 1 650 470n
preplace netloc xlconstant_1_dout 1 1 1 620 400n
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 20 20 630 570 1130
preplace netloc DMA_M_AXI_S2MM 1 0 4 10 10 N 10 N 10 1520
preplace netloc ZYNQ_PS_M_AXI_HPM0_FPD 1 1 1 N 90
preplace netloc ZYNQ_PS_M_AXI_HPM1_FPD 1 1 1 N 110
preplace netloc axi_dma_0_M_AXIS_MM2S 1 1 3 640 20 N 20 1510
preplace netloc axi_interconnect_0_M00_AXI 1 2 1 1120 180n
preplace netloc xfft_0_M_AXIS_DATA 1 2 1 1140 290n
levelinfo -pg 1 -10 330 900 1330 1550
pagesize -pg 1 -db -bbox -sgen -10 0 1550 580
"
}
...
# End of cr_bd_zynqmp_system()
cr_bd_zynqmp_system ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files zynqmp_system.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files zynqmp_system.bd ] 
set_property IS_ENABLED "1" [get_files zynqmp_system.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files zynqmp_system.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files zynqmp_system.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files zynqmp_system.bd ] 
set_property PFM_NAME "" [get_files zynqmp_system.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files zynqmp_system.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zynqmp_system.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files zynqmp_system.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files zynqmp_system.bd ] 
set_property USED_IN_SIMULATION "1" [get_files zynqmp_system.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files zynqmp_system.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse zynqmp_system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../ZynqMP_FFT.gen/sources_1/bd/zynqmp_system/hdl/zynqmp_system_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse zynqmp_system.bd] -top]
...
set_property -name "incremental_checkpoint" -value "$proj_dir/ZynqMP_FFT.srcs/utils_1/imports/synth_1/zynqmp_system_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ZynqMP_FFT.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/ZynqMP_FFT.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ZynqMP_FFT.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
